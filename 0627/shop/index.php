...
<body>
					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								?>
									<li><a><?php echo $logged; ?></a></li>
									<li><a href="./order_list.php"><i class="fa fa-shopping-cart"></i>주문정보</a></li>
									<li><a href="./cart.php"><i class="fa fa-shopping-cart"></i> 장바구니</a></li>
									<li><a href="./php/logout.php"><i class="fa fa-lock"></i> 로그아웃</a></li>
									<li><a href="./mypage.php"><i class="fa fa-lock"></i> 정보수정</a></li>
								<?php } ?>
							</ul>
						</div>
					</div>
	...
	<article class="col-xl-12">
		<img src="./images/home/main_banner.jpg" alt="" width="100%" style="margin-bottom:30px">
	</article>
	<section>
		<div class="container">
			<div class="row">
