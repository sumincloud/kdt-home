<?php
  ...
  //$sql = " SELECT PASSWORD('$mb_password') AS pass "; //MySQL 5.6 이하 사용 가능. 
  //****수정부분******
  $hashpassword = password_hash($mb_password, PASSWORD_DEFAULT); //MySQL 5.5 이상 사용 가능. 
