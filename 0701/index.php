...
<html lang="ko">
	...
	<body>
		...
		<article class="col-xl-12">
			<img src="./images/home/main_banner.jpg" alt="메인이미지" style="width:100%;padding-bottom:50px;">
		</article>
		...
		<section>
			<div class="container">
				<div class="row">
					...
					<!-- 2. 베스트 상품목록 -->
					<?php
						$sql = "select * from shop_data where cate='cate02'"; 
						$result = mysqli_query($conn, $sql);
					?>
			
						<div class="features_items"> <!-- best 제품 목록-->
