      ...
      <section>
        ...
        <table class="free_board table table-striped table-hover">
          <caption>글내용 보기</caption>
            ...
            <tr>
              <th>내용</th>
              <td class="memo"><?php echo nl2br($row['memo']);?></td>
            </tr>
            <tr>
              <th>작성일</th>         
            ...
            <tr>
              <td colspan="2">
                ...
                <input type="submit" name="action" value="수정" onclick="submitForm('./php/update.php')" class="btn btn-primary">
                <input type="submit" name="action" value="삭제" onclick="submitForm('./php/delete.php')" class="btn btn-danger">

                <p class="btn_box">
                  <a href="./list.php" title="목록보기" class="btn btn-secondary">목록보기</a>
                </p>
              </td>
            </tr>
        </table>
